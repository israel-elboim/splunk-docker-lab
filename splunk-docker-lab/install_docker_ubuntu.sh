...
# ==============================================================================
# Title: Docker & Docker Compose Installer for Ubuntu
# Description: This script automates the installation of Docker Engine
#              and the Docker Compose plugin on a fresh Ubuntu system.
# Author: Israel Elboim
#
# Usage:
# 1. Make the script executable: chmod +x install_docker_ubuntu.sh
# 2. Run with sudo: ./install_docker_ubuntu.sh
